    ...
    <div className="p-4 border-b border-gray-200 flex items-center justify-end">
      ...
      <div className="flex items-center space-x-2 ml-4">
        ...
        <button
          ...
          className={`px-6 py-3 rounded-md text-sm font-medium ${selectedFilter ? "bg-gray-500 text-white hover:bg-gray-600 cursor-pointer" : "bg-gray-200 text-gray-500 cursor-not-allowed"}`}
        >
          Filter
        </button>
      </div>
